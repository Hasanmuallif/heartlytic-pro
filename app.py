...
with st.sidebar:
    ...
    st.markdown(
        f"""<h2 style='text-align: center; letter-spacing: 2px; color: #FF4B4B; margin-top: -50px; margin-bottom: 0px;'> HEARTLYTIC <span style='color: var(--text-color); font-weight: bold;'>PRO</span></h2>
        """, unsafe_allow_html=True)
    st.markdown(
